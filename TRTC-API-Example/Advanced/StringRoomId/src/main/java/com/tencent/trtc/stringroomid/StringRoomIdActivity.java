 ...
 * .com/doc/api/zh-cn/group__TRTCCloud__android.html#abfc1841af52e8f6a5f239a846a1e5d5c}.
 */
        ...
        if (view.getId() == R.id.iv_back) {
            ...
            if (!mStartPushFlag) {
                if (!TextUtils.isEmpty(roomId) && !TextUtils.isEmpty(userId)) {
                    ...
                    Toast.makeText(StringRoomIdActivity.this,
                            getString(R.string.stringroomid_please_input_roomid_userid), Toast.LENGTH_SHORT).show();
                }
            } else {
