 ...
 * - To learn about player APIs, see
 * <a href="https://liteav.sdk.qcloud.com/doc/api/zh-cn/group__TXLivePlayer__android.html">TXLivePlayer</a>.
 */
        ...
        public void onClick(View v) {
            if (mIsPlaying) {
                ...
                if (TextUtils.isEmpty(mEditStreamId.getText())) {
                    Toast.makeText(PushCDNAudienceActivity.this, R.string.pushcdn_audience_empty_stream_id_tip,
